...
const HeroUpload = () => {
    ...
    return (
        <div
            ...
            className={cn(
                "relative mx-auto flex w-full cursor-pointer flex-col items-center justify-center gap-6 rounded-[2rem] px-8 py-16 text-center transition-all duration-300",
                dragging
        ...
        >
            ...
            <FileFormatsDisplay acceptedExtensions={ACCEPTED} />
        </div>
    );
};

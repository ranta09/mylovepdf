            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-secondary/30 rounded-2xl p-4 text-center">
                  <p className="text-[10px] font-black uppercase text-muted-foreground mb-1">Original Size</p>
                  <p className="text-xl font-black text-primary">{results.originalSize}</p>
                </div>
                <div className="bg-secondary/30 rounded-2xl p-4 text-center">
